...
public abstract class MapObject
{
	...
	// Takes in another map object and checks to see if this' hit box intersects
	// the passsed in params hitbox
	...
	public int getWidthOfSpriteSheet()
	{
		return (int) spriteSheetWidth;
	}

	public int getHeightOfSpriteSheet()
	{
		return (int) spriteSheetHeight;
	}
	...
	public void setIsMovingUp(boolean b)
	{
		isMovingUp = b;
	}

	public void setIsMovingDown(boolean b)
	{
		isMovingDown = b;
	}
	...
	{
		return x + xmap + spriteSheetWidth < 0 || x + xmap - spriteSheetWidth > GamePanel.WIDTH
				|| y + ymap + spriteSheetHeight < 0 || y + ymap - spriteSheetHeight > GamePanel.HEIGHT;
	}
}
